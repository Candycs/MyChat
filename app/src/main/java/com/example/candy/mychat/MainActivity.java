package com.example.candy.mychat;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUsersRef.child("id-12345").setValue("Chompunut");
        mMessagesRef.setValue("Hello World!");

        final FriendlyMessage friendlyMessage = new FriendlyMessage("Hello World!", "Chompunut");
        mMessagesRef.push().setValue(friendlyMessage);

        String key = mMessagesRef.push().getKey();

        HashMap<String, Object> postValues = new HashMap<>();
        postValues.put("username", "Chompunut");
